 ...
 */
final class Version20200721073528 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE incident (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, target_id INT NOT NULL, criterion_id INT NOT NULL, description LONGTEXT NOT NULL, proof LONGTEXT NOT NULL, f_positive TINYINT(1) NOT NULL, f_delete TINYINT(1) NOT NULL, f_moder TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, update_at DATETIME DEFAULT NULL, INDEX IDX_3D03A11AF675F31B (author_id), INDEX IDX_3D03A11A158E0B66 (target_id), INDEX IDX_3D03A11A97766307 (criterion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
